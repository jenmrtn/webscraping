...
table_rows= soup.findAll("tr") #list of all the table rows in the html
...
for row in table_rows[2:52]:  #Iterating through that list starting after the headers, within the row we are looking for all the individual cells. This gives you all the html for the columns
    td = row.findAll("td")
    #print(td)
